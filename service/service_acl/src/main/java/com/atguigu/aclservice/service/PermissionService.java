...
public interface PermissionService extends IService<Permission> {
    ...
    //获取全部菜单
    List<Permission> queryAllMenuUnderdogEdu();

    //递归删除菜单
    void removeChildByIdUnderdogEdu(String id);

    void saveRolePermissionRealtionShipUnderdogEdu(String roleId, String[] permissionId);
}
