...
public class UcenterMemberController {
    ...
    @ValidateToken
    @GetMapping("getUserSignInfo/{year}/{month}")
    public R getUserSignInfo(@PathVariable Integer year, @PathVariable Integer month, HttpServletRequest request) {
        return ucenterMemberService.getUserSignInfo(year, month, request);
    }
}
