...
public interface UcenterClient {
    ...
    UcenterMemberPay getUcenterPay(@PathVariable("memberId") String memberId,@RequestHeader(name = "token", required = true) String token);
    ...
    boolean updateUseruCoinById(@PathVariable("count") Integer count, @PathVariable("id") String id,@RequestHeader(name = "token", required = true) String token);
