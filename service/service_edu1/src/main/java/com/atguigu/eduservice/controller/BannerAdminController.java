 ...
 */
@RestController
@RequestMapping("/eduservice/educms/banneradmin")
public class BannerAdminController {
    ...
    @PostMapping("save")
    public R save(@Validated(AddGroup.class) @RequestBody CrmBanner banner) {
    ...
    @PostMapping("update")
    public R updateById(@Validated(UpdateGroup.class)@RequestBody CrmBanner banner) {
